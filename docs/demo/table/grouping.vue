...
const tableColumns = ref<TableColumns<TableDataGroupItem>>([
  { prop: 'id', label: '编号', width: 110, align: 'left', sortable: true },
  {
    ...
    children: [
      { prop: 'basic.name', label: '姓名', width: 80, align: 'center' },
      {
        ...
        width: 60,
        align: 'center',
        formatter: ({ row }) => getOptionText(genderOptions, row.basic.gender),
      },
      {
        prop: 'basic.age',
        label: '年龄',
  ...
  },
  {
    ...
    children: [
      ...
      { prop: 'education.school', label: '学校', width: 100, align: 'center' },
      { prop: 'education.major', label: '专业', width: 120, align: 'center' },
      {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { prop: 'contact.address.addressDetail', label: '详细地址', width: 200, align: 'center' },
        ],
      },
    ],
  },
