...
const operationType = ref<'button' | 'link' | 'text'>('text')
...
const tableColumns = ref<TableColumns<TableDataItem>>([
  ...
  },
  {
    ...
    fixed: 'right',
    component: 'operation',
    attrs: { type: operationType, operations },
  },
])
</script>

<template>
  <el-radio-group v-model="operationType" size="large" class="mb-2">
    <el-radio-button label="按钮" value="button" />
    <el-radio-button label="链接" value="link" />
